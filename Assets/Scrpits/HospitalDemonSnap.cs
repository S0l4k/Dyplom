...
public class HospitalDemonSnap : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            Debug.LogWarning("[HospitalDemonSnap] ⚠️ Brak przypisanych obiektów demona!");
            return;
        }

        // ✅ Start: włącz pierwszego, wyłącz resztę
        SetActiveDemon(0);
        StartCoroutine(MonitorAndSnap());
    }

    /// <summary>
    /// Sprawdza co 0.5s czy włączyć/wyłączyć snapowanie
    /// </summary>
    private IEnumerator MonitorAndSnap()
    {
        while (true)
        {
            ...
            else
            {
                ...
                // ✅ Ukryj wszystkie, gdy nie w trybie szpitala
    ...
    /// <summary>
    /// Pętla przełączająca demona co snapInterval
    /// </summary>
    ...
    /// <summary>
    /// Włącza tylko demona o podanym indeksie, resztę wyłącza
    /// </summary>
