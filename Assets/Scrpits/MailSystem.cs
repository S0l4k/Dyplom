...
public class MailSystem : MonoBehaviour
{
    ...
    void CreateExorcismThread()
    {
        var convo = new List<Message> {
            ...
            new Message("Jack White",
                "Blessings,\n\nI am writing to you because on the website of the Church of the Blessed Virgin Mary, you were listed as an exorcist.\n\nMy name is Jack. I spent the last fifteen years in a psychiatric institution because of visions of a strange entity that first appeared in my life when I was a child, shortly after my friends and I tried summoning spirits as a game.\n\nAfter years of psychiatric treatment and medication, the visions eventually stopped. Unfortunately, the entity has recently begun appearing again.\n\nI see it in reflections in puddles, store windows, sometimes standing far behind crowds of people. Every day it gets closer to me. It has started appearing in my dreams again, and I can hear it whispering in my ear.\n\nDo you know what kind of entity this could be?\n\nSincerely,\n\nJack White",
    ...
    void CreateMaryThread()
    {
        var convo = new List<Message> {
            ...
            // 4. Jack
            new Message("Jack White",
                "Thanks for today.\n\nIt was really good seeing you again after all these years. I think I forgot what it feels like to feel normal around someone familiar.\n\nHopefully we can do it again sometime.",
                isPlayer: true, timestamp: ""),
    ...
    {
        if (allEmails.Exists(e => e.id == email.id)) return;
        allEmails.Add(email);
        inbox.Add(email);
